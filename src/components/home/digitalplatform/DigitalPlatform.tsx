...
export default function DigitalPlatform() {
  ...
  return (
    <div className="  bg-white relative overflow-hidden max-w-7xl mx-auto mt-11 py-52">
      {/* Background Pattern */}
    <img style={{width:'1200px'}} src="/homepage/bg3.png" alt="ggg"  className='absolute '/>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="flex max-md:flex-col gap-12 items-center">
          ...
          <div data-aos="fade-right" className="space-y-[50px] w-[50%]  max-md:w-full">
            ...
            <p style={{lineHeight:'40px'}} className="text-xl md:text-2xl font-sfui font-[400] text-[#1A1A1A] max-w-xl ">
          ...
          <div className="relative w-[50%] max-md:w-full">
            {/* Cloud Storage Icon */}
            <img src="/homepage/digital.png" alt="img" className=' w-[1200px] ' />
          </div>
        </div>
      </div>
    </div>
